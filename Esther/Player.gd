...
# Button Textures
var default_button_texture = load("res://Esther/resources/ButtonBase.tres")
var focused_button_texture = load("res://Esther/resources/ButtonBaseFocused.tres")
var pressed_button_texture = load ("res://Esther/resources/ButtonBasePressed.tres")
