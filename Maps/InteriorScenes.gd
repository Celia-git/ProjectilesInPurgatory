...
var portal_scene_path = "res://Maps/portal.tscn" 
var ui_color 
var game_path 
var sub_scenes
var backgrounds
...
func _ready():
	...
	for scene in sub_scenes:
		var game = load(game_path+scene).instantiate()
...
func set_portal():
	...
	$Control.add_child(portal)
	portal.set_anchors_preset(Control.PRESET_TOP_LEFT)
	portal.pressed.connect(_on_portal_pressed)
	portal.mouse_entered.connect(_on_button_mouse_entered)
	portal.mouse_exited.connect(_on_button_mouse_exited)
