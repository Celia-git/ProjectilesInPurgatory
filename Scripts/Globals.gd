...
var load_states = load("res://Scripts/LoadStates.gd")
...
var player_script = "res://Scripts/Player.gd"
var game_script = "res://Scripts/GameData.gd"
...
# Graphics data
var texture_script = load("res://Scripts/LoadTextures.gd")
