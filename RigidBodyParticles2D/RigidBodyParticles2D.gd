...
var emitting = true : get = get_emitting, set = set_emitting
var amount = 24
var amount_random = .1
var particle_scene = preload("res://IceCream/Toppings/particle.tscn")
@export var one_shot = true
var explosiveness = 0
var tracker_name = "ParticleTracker"
var emission_shape:Shape2D

var lifetime = 6
var lifetime_random = 0

var impulse = 200
var impulse_random = 0
var impulse_angle_degrees = 0
var impulse_spread_degrees = 0

var force = 0
var force_random = 0
var force_angle_degrees = 0
var force_spread_degrees = 0

var initial_rotation_degrees = 0
var initial_rotation_degrees_random  = 0
...
var _iteration  = 0
@onready var _tracker_scene = load("res://RigidBodyParticles2D/ParticleTracker.tscn")
	...
	for i in frame_emit_count:
		...
		if emission_shape:
			if emission_shape.get_class() == 'CircleShape2D':
				...
				particle_pos.x = emission_shape.size.x * ( 2 * randf() - 1 )
				particle_pos.y = emission_shape.size.y * ( 2 * randf() - 1 )
